// gpu_dds_publisher.cpp - Fast DDS Publisher with GPU (Fixed)
...
int main() {
    std::cout << "========================================\n";
    std::cout << "GPU-DDS Publisher with CUDA (Fixed)\n";
    std::cout << "4 Streams, 4 Kernels\n";
    std::cout << "========================================\n";
